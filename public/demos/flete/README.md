...
Pruebas: `tests/flete-preview.spec.ts` usa HTTP e IndexedDB nativos en Chromium y WebKit. El resultado no equivale a una validación en un iPhone físico ni a una puesta en producción.
